...
//        String customArgs = HalvadeConf.getCustomArgs(context.getConfiguration(), "snpsift", "intidx");  
    ...
    public int callElPrep(String input, String output, String rg, int threads, 
            ...
            SAMFileHeader header, String dictFile) throws InterruptedException, QualityException, IOException {
...
//        runProcessAndWait(command);
    ...
    public void callSAMToBAM(String input, String output, int threads) throws InterruptedException, IOException {
    ...
    //public int callBamView(String bin, String input) throws InterruptedException, IOException {
    //    String[] command = { bin, "view", "-c", input};
	//	  long estimatedTime = runProcessAndWait("samtools view -c ...", command);
    //}
    
    private long runProcessAndWait(String name, String[] command) throws InterruptedException, IOException {
        long startTime = System.currentTimeMillis();
        ProcessBuilderWrapper builder = new ProcessBuilderWrapper(command, null);
        builder.startProcess();
        int error = builder.waitForCompletion();
    ...
    public int runBuildBamIndex(String input) throws InterruptedException, IOException {
        String tool;
        if(bin.endsWith("/")) 
    ...
    public int runAddOrReplaceReadGroups(String input, String output,
            ...
            String RGPU, String RGSM) throws InterruptedException, IOException {
        String tool;
        if(bin.endsWith("/")) 
    ...
    public int runSortVcf(String input, String output) throws InterruptedException, IOException {
        String tool;
        if(bin.endsWith("/")) 
    ...
    public int runMarkDuplicates(String input, String output, String metrics) throws InterruptedException, IOException {
        String tool;
        if(bin.endsWith("/")) 
    ...
    public int runCleanSam(String input, String output) throws InterruptedException, IOException {
        String tool;
        if(bin.endsWith("/")) 
